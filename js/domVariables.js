//Navbar animation hamburgers
export const navToggleBtn = document.querySelector('.navbar-toggler');
export const navCollapseDiv = document.querySelector('.navbar-collapse');

//login button-navbar first page
